...
void BloomEffect::Init(unsigned width, unsigned height)
{
	...
	_shaders.push_back(Shader::Create());
	_shaders[index]->LoadShaderPartFromFile("shaders/passthrough_vert.glsl", GL_VERTEX_SHADER);
	_shaders[index]->LoadShaderPartFromFile("shaders/post/BlurHorizontal.glsl", GL_FRAGMENT_SHADER);
	_shaders[index]->Link();
	...
	_shaders.push_back(Shader::Create());
	_shaders[index]->LoadShaderPartFromFile("shaders/passthrough_vert.glsl", GL_VERTEX_SHADER);
	_shaders[index]->LoadShaderPartFromFile("shaders/post/BlurVertical.glsl", GL_FRAGMENT_SHADER);
	_shaders[index]->Link();
